                            ...
                            <form id="add_student">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-25">
                                            ...
                                            <input class="form-control form-control-lg" type="text" name="memberid" placeholder="Enter member id">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-25">
                                            ...
                                            <input class="form-control form-control-lg" type="text" name="fullname" placeholder="Enter full name">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-25">
                                            ...
                                            <input class="form-control form-control-lg" type="text" name="displayname" placeholder="Enter display name">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-25">
                                            <label>Year</label>
                                            <input class="form-control form-control-lg" type="text" name="year" placeholder="Enter year">
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group mb-25">
                                        ...
                                        <input class="form-control form-control-lg" type="text" name="telephone" placeholder="Enter telephon no">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-25">
                                        <label>Gender</label>
                                        <div class="col-sm-12">
                                            <input type="radio" name="gender" value="1" required  style="position: initial;opacity:1;margin: 10px;height: 15px;transform: scale(1.5)" checked> Male
                                            <input type="radio" name="gender" value="0" required  style="position: initial;opacity:1;margin: 10px;height: 15px;transform: scale(1.5)"> Female
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-25">
                                        ...
                                        <input class="form-control form-control-lg" type="date" name="dob" placeholder="Enter date of birth">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-25">
                                                ...
                                                <input class="form-control form-control-lg" type="text" name="parentname" placeholder="Enter parent name">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-25">
                                                ...
                                                <input class="form-control form-control-lg" type="text" name="parentphone" placeholder="Enter parent tel no">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-0">
                                            <button  class="btn btn-lg btn-primary btn-submit" id="save-student">Add Student</button>
                                        </div>
                                    </div>
                                </div>
                            </form> 
...
<script>
    $("#save-student").click(function (e) {
        ...
        function add_student($form) {
            ...
            formdata.append('form_name', 'add_student');

            $.ajax({
                type: 'post',
                dataType: "JSON",
                url: '<?php echo base_url(); ?>index.php/student/func_add_student',
                data: formdata,
                cache: false,
                contentType: false,
                processData: false,
                success: function (data) {
                   ...
                   if (data['status'] == "true") {
                    ...
                    setTimeout(function () {
                        ...
                        window.location = "<?php echo base_url() ?>index.php/student"
                    }, 5000);

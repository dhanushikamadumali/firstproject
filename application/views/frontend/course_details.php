            ...
            <div class="page-banner__wrapper">
                <div class="container">
                    ...
                    if ($this->input->get('id')):
                        $course=$this->Common_model->get_all("course",array('id' => $this->input->get('id')))->result();
                        if ($course !=NULL):
                        $countenrollid = $this->db->query('SELECT COUNT(member_id) as countmemberid FROM course_enroll  WHERE course_id="'.$this->input->get('id').'"')->result();
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="tutor-course-top-info__content">
                            ...
                            <h1 class="tutor-course-top-info__title" style="text-transform: capitalize;"><?php echo ($course[0]->title)?></h1>
                            ...
                            <div class="tutor-course-top-info__meta">
                                ...
                                <div class="tutor-course-top-info__meta-action"><i class="meta-icon far fa-user-alt"></i> <?php echo $countenrollid[0]->countmemberid ?> already enrolled</div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="tutor-course-main-segment">
                            ...
                            <div class="tutor-course-segment">
                                <h4 class="tutor-course-segment__title" style="margin-top: 20px;">About This Course</h4>
                            ...
                            if($this->session->userdata('member_id') ):
                                $this->db->select('member_id ,course_id');
                                $course_member_check=$this->Common_model->get_all("course_enroll",array('course_id' => $this->input->get('id'),'member_id' => $this->session->userdata('member_id')))->result();
                           
                                if($course_member_check !=NULL):
                            ?>

                                <div class="tutor-course-segment">

                                <div class="tutor-course-segment__header">
                                    <h4 class="tutor-course-segment__title">Course Module</h4>
                                </div>
                                ...
                                <div class="course-curriculum accordion">
                                    ...
                                    <?php
                                        $course_module=$this->Common_model->get_all("course_module",array('course_id' => $this->input->get('id')))->result();
                                        if($course_module ):
                                        foreach($course_module as $comodule):

                                        ?>
                                        <button class="accordion-button"> <i class="tutor-icon"></i>
                                        <a href="<?php echo base_url() ?>index.php/frontend/course_enroll_module?id=<?php echo $comodule->id ?>"
                                        ><?php echo ($comodule->title) ?></a>
                                        </button>
                                        <?php
                                        endforeach;
                                            endif;
                              ...
                              <?php
                                ...
                                <div class="tutor-course-price-preview__btn">
                                      <button type="button" class="btn btn-primary btn-hover-secondary w-100 course_enroll" onclick="course_entroll('<?php echo  $this->input->get('id') ?>','<?php echo $this->session->userdata('member_id') ?>')">Course Enroll</button>
                                </div>
                                </div>
                                ...
                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                <div class="tutor-course-price-preview__btn">
                                      <a  href="<?php echo base_url(); ?>index.php/frontend/login" class="btn btn-primary btn-hover-secondary w-100" >Course Enroll</a>
                                </div>
                                </div>
                            ...
                            <!-- Tutor Course Segment Start -->
                            <div class="tutor-course-segment">
                                <h4 class="tutor-course-segment__title" style="margin-top: 20px;">Student Feedback</h4>
                                            ...
                                            <div class="comment-item-02">
                                                <div class="comment-item-02__header">
                                                    <div class="comment-item-02__author">
                                                        <img src="<?php echo base_url(); ?>assets/frontend/images/avatar/avatar-02.jpg" alt="Avatar" width="52" height="52">
                                                    </div>
                                                    <div class="comment-item-02__info">
                                                        <h6 class="comment-item-02__name"><a href="#">Chérif Akadiry</a></h6>
